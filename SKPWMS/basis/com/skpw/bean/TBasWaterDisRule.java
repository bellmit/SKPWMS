 ...
 */
@Entity
@Table(name = "T_BAS_WaterDisRule")
public class TBasWaterDisRule implements  Serializable{
	...
	private String fwaterDisRuleId;
	private String fwaterDisRuleCode;
	private String fwaterDisRuleName;
	...
	@Column(name = "FWaterDisRuleID", unique = true, nullable = false, length = 32)
	public String getFwaterDisRuleId() {
		return this.fwaterDisRuleId;
	}
	...
	@Column(name = "FWaterDisRuleCode", length = 60)
	public String getFwaterDisRuleCode() {
		return this.fwaterDisRuleCode;
	}

	public void setFwaterDisRuleCode(String fwaterDisRuleCode) {
		this.fwaterDisRuleCode = fwaterDisRuleCode;
	}

	@Column(name = "FWaterDisRuleName", length = 100)
	public String getFwaterDisRuleName() {
		return this.fwaterDisRuleName;
	}

	public void setFwaterDisRuleName(String fwaterDisRuleName) {
		this.fwaterDisRuleName = fwaterDisRuleName;
	}
