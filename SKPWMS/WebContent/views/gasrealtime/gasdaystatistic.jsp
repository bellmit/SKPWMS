...
$(function () {
	...
	function searchDatagrid() {
		...
		var statistictime=$('#time_static').datebox('getValue');
		$('#datagrid').datagrid({  
		    url:'<%=path %>/gas/statisticDayReport', 
		    queryParams:{  
		        "controlid":controlid,
...
<body class="easyui-layout">
		...
		<form style="margin-top: 10px">
			<table>
				<tr>
					...
					<tr>
					<td class="a">统计时间：</td>
					<td class="b"><input type="text" id="time_static" value="${statisticime}" class="easyui-datebox" name="time_static" editable="false" style="width: 222px;"></td>
	...
	<table id="datagrid" class="easyui-datagrid" style="width:100%;height:100%" fit="true" pagination="false"  rownumbers="true" singleSelect="true" striped="true">
