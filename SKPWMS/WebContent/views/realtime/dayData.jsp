...
$(document).ready(function(){
	...
	$("#ctree").tree({
		onDblClick:function(node){
			...
			//刷新Datagrid
			$('#datagrid').datagrid({  
			    url:'<%=path %>/dayDataController/findByList',  
			    queryParams:{  
			        "cId":cId,  
			        "time":time  
			    }  
...
<body class="easyui-layout">
	...
	<div data-options="region:'east',iconCls:'icon-reload',split:false" style="width:250px;">
		...
		<div >
			统计日期：<input id="ctime" name="ctime" type="text" class="Wdate"  onclick="WdatePicker({dateFmt:'yyyy-MM',minDate:'2000-1',maxDate:'2050-12'})" readonly="readonly" style="width: 150px;"/>
		</div>
	</div>
</body>
</html>