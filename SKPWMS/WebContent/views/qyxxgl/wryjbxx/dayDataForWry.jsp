...
<body class="easyui-layout">
	...
	<div data-options="region:'east',iconCls:'icon-reload',split:false" style="width:200px;">
		...
		<div style="margin: 5px 0px;">
			日期：<input id="ctime" name="ctime" type="text" class="Wdate"  onclick="WdatePicker({dateFmt:'yyyy-MM',minDate:'2000-1',maxDate:'2050-12'})" readonly="readonly" style="width: 150px;"/></p>
		</div>
	</div>
</body>
</html>