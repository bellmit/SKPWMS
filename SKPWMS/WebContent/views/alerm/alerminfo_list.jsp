...
<script type="text/javascript">
	$(function() {
		...
		$('#list_data').datagrid({
			...
			fit : true,//自动大小  
			url : '${path}/SKPWMS/alerm/showAlermInfoByCondition',
			//sortName: 'code',  
			//sortOrder: 'desc',  
			remoteSort : false,
			idField : 'id',
	...
	<div data-options="region:'north'" style="height: 50px">
		<form>
			<table>
				<tr>
					<td class="a">报警参数：</td>
					<td class="b"><input id="rt_alermparam" name="alermparam"
		...
		<table id="list_data" cellspacing="0" cellpadding="0">
			<thead>
				...
				if (row.pollutant){
					...
					<th data-options="field:'alermparam'">报警因子</th>
					<th data-options="field:'alermtime',formatter:function(value,row,index){return value?value.substring(0,19):'';}">报警时间</th>
					<th data-options="field:'alermreason'">报警事由</th>
					<th data-options="field:'alermvalue'">报警值</th>
					<th data-options="field:'alermstand'">报警标准</th>
