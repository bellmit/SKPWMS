<%@ page language="java" import="java.util.*,com.skpw.common.ContextHolderUtils" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<t:formvalid formid="formobj" refresh="false" dialog="true" action="/sys/editPassword" usePlugin="password" layout="table">
	<input id="id" name="userid" type="hidden" value="${userinfo.id }">
